...
do
  ...
  do
    ...
    then
      # ./../sources/statMC_sigma_importance_v6.out $MC_file $COUNT_MAX parameters_temp.txt parameters_ref.txt
    ...
    # echo $N $Q $ERROR_MAX $LAMBDA_REG1 $LAMBDA_REG2 $ERROR_MIN_UPDATE $MEFF
